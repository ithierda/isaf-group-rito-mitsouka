...
|---|---|---|---|
| A — Client, data | 1–3 | 1 | 2:00 |
| B — Two choices that decide everything | 4–5 | 2 | 2:00 |
| C — Performance | 6–7 | 3 | 2:00 |
| D — Interpretability | 8–10 | 4 | 2:30 |
| E — Stability | 11–12 | 5 | 2:00 |
| F — Fairness | 13–15 | 6 | 2:30 |
| G — Recommendation + app | 16–18 | 1 (bookend) | 2:00 |

Total 15:00. Rehearse at 13:30 — a jury talk always runs long.
...
- Source: Fisman, Iyengar, Kamenica & Simonson (2006), QJE — Speed Dating Experiment.
...
- Add, because it is a point in your favour: we tried 18 more engineered features, attribute-level
  preference fits, directional `raceclash`, income gaps — every variant landed inside the same
...
- Method in one line: lasso **selects**, an unpenalised logit is refitted on the selected columns
  to get standard errors. Those p-values ignore the selection step — read them as an ordering.
...
- Setup: **25 versions of each model** — 5 CV folds + 20 bootstrap resamples drawn within waves.
...
**"Not whether the participants preferred their own background — they did, that is descriptive.
...
- Conditional parity (Cochran–Mantel–Haenszel), conditioning on four variables we commit to as
...
### Slide 14 — Amplification (45 s) — this is your original contribution, sell it
...
2. **Ship it with the anchoring penalty (λ ≈ 0.3).** Stability normally costs performance; here it
   pays for itself — PR-AUC 0.287 → 0.312 and 84% less drift between retrainings. There is no
